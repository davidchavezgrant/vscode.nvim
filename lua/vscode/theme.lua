...
theme.set_highlights = function(opts)
    ...
    hl(0, 'ErrorMsg', { fg = c.vscRed, bg = c.errorBack })
    hl(0, 'VertSplit', { fg = c.vscSplitDark, bg = "NONE"})
    ...
    hl(0, 'LineNr', { fg = c.default, bg = c.vscBack })
    hl(0, 'CursorLineNr', { fg = c.vscYellow, bg = c.vscBack })
    ...
    hl(0, 'Identifier', { fg = c.default, bg = 'NONE' })
    hl(0, 'Function', { fg = c.riderGreen, bg = 'NONE' })
    hl(0, 'Statement', { fg = c.vscPink, bg = 'NONE' })
    hl(0, 'Conditional', { fg = c.monokaiPink, bg = 'NONE' })
    hl(0, 'Repeat', { fg = c.monokaiPink, bg = 'NONE' })
    hl(0, 'Label', { fg = c.monokaiPink, bg = 'NONE' })
    hl(0, 'Operator', { fg = c.monokaiPink, bg = 'NONE' })
    hl(0, 'Keyword', { fg = c.monokaiPink, bg = 'NONE' })
    hl(0, 'Exception', { fg = c.monokaiPink, bg = 'NONE' })
    hl(0, 'PreProc', { fg = c.monokaiPink, bg = 'NONE' })
    hl(0, 'Include', { fg = c.monokaiPink, bg = 'NONE' })
    hl(0, 'Define', { fg = c.monokaiPink, bg = 'NONE' })
    hl(0, 'Macro', { fg = c.monokaiPink, bg = 'NONE' })
    ...
    hl(0, 'Error', { fg = c.vscRed, bg = c.errorBack, undercurl = true, sp = c.vscRed })
    ...
    hl(0, 'WinBar', { fg = c.vscFront, bg = "NONE", bold = true })
    hl(0, 'WinBarNc', { fg = c.vscFront, bg = "NONE"})
    hl(0, 'QuickFixLine', { bold = true })

    -- Treesitter
    hl(0, '@error', { fg = c.vscRed, bg = c.errorBack }) -- Legacy
    hl(0, '@punctuation.bracket', { fg = c.punctuation, bg = 'NONE' })
    hl(0, '@punctuation.special', { fg = c.punctuation, bg = 'NONE' })
    hl(0, '@punctuation.delimiter', { fg = c.punctuation, bg = 'NONE' })
    hl(0, '@comment', { fg = c.vscGreen, bg = 'NONE', italic = opts.italic_comments })
    hl(0, '@comment.note', { fg = c.vscBlueGreen, bg = 'NONE', bold = true })
    hl(0, '@comment.warning', { fg = c.vscYellowOrange, bg = c.warningBack, bold = true })
    hl(0, '@comment.error', { fg = c.vscRed, bg = c.errorBack, bold = true })
    ...
    hl(0, '@boolean', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, '@annotation', { fg = c.riderGreen, bg = 'NONE' })
    hl(0, '@attribute', { fg = c.riderGreen, bg = 'NONE' })
    hl(0, '@attribute.builtin', { fg = c.vscBlueGreen, bg = 'NONE' })
    hl(0, '@module', { fg = c.vscBlueGreen, bg = 'NONE' })
    hl(0, '@function', { fg = c.riderGreen, bg = 'NONE' })
    hl(0, '@function.builtin', { fg = c.riderGreen, bg = 'NONE' })
    hl(0, '@function.macro', { fg = c.riderGreen, bg = 'NONE' })
    hl(0, '@function.method', { fg = c.riderGreen, bg = 'NONE' })
    hl(0, '@define', { fg = c.monokaiPink, bg = 'NONE' })
    hl(0, '@variable', { fg = c.default, bg = 'NONE' })
    ...
    hl(0, '@variable.member', { fg = c.riderLightPurple, bg = 'NONE' })
    hl(0, '@property', { fg = c.riderPurple, bg = 'NONE' })
    hl(0, '@constructor', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, '@label', { fg = c.vscLightBlue, bg = 'NONE' })
    hl(0, '@keyword', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, '@keyword.conditional', { fg = c.monokaiPink, bg = 'NONE' })
    hl(0, '@keyword.repeat', { fg = c.monokaiPink, bg = 'NONE' })
    hl(0, '@keyword.return', { fg = c.monokaiPink, bg = 'NONE' })
    hl(0, '@keyword.exception', { fg = c.monokaiPink, bg = 'NONE' })
    hl(0, '@keyword.import', { fg = c.monokaiPink, bg = 'NONE' })
    hl(0, '@operator', { fg = c.monokaiPink, bg = 'NONE' })
    ...
    hl(0, '@lsp.typemod.keyword.controlFlow', { fg = c.monokaiPink, bg = 'NONE' })
    ...
    hl(0, 'DiagnosticError', { fg = c.vscRed, bg = c.errorBack })
    hl(0, 'DiagnosticWarn', { fg = c.vscYellow, bg = c.warningBack  })
    ...
    -- COC.nvim
    hl(0, 'CocHighlightText', { fg = 'NONE', bg = isDark and c.vscopupHighlightGray or c.vscPopupHighlightLightBlue })
